    ...
    <div className="modal-content rounded-5 shadow">
      ...
      <div className="modal-body p-5 pt-0">
        ...
        <div className="form-floating mb-3">
            <input type="text" className="form-control rounded-4" id="floatingInput" placeholder="name@example.com" {...register('name')} />
...
//     <input type="text" className="form-control"  aria-describedby="nameHelp" {...register('name')} />
//   </div>
//   <div className="mb-3">
